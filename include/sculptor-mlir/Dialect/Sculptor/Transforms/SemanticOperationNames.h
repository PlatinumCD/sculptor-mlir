#ifndef SCULPTOR_MLIR_DIALECT_SCULPTOR_TRANSFORMS_SEMANTICOPERATIONNAMES_H
#define SCULPTOR_MLIR_DIALECT_SCULPTOR_TRANSFORMS_SEMANTICOPERATIONNAMES_H

#include "llvm/ADT/StringRef.h"

namespace mlir {
namespace sculptor {
namespace semantic_operation_names {
...
#endif // SCULPTOR_MLIR_DIALECT_SCULPTOR_TRANSFORMS_SEMANTICOPERATIONNAMES_H
