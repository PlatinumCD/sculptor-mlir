...
module {
  ...
  func.func private @task_matrix_large() -> !sculptor.logical.array {
    %matrix = arith.constant dense<1.000000e+00> : tensor<2x25xf32>
    %array = sculptor.array.set %matrix : tensor<2x25xf32> -> !sculptor.logical.array
    return %array : !sculptor.logical.array
  }
  ...
  func.func private @generate_task_graph() -> !sculptor.task_graph {
    ...
    %setup1 = sculptor.task.create %graph, @task_matrix_large, domain = "analog", task_kind = "sculptor.matrix_setup", task_name = "layer1_matrix", source_layer = "layer1", source_task_ordinal = 0, inputs[], outputs[%array1], deps[] : (!sculptor.task_graph, !sculptor.task_resource<!sculptor.logical.array>) -> !sculptor.task
