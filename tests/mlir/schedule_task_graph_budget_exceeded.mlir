...
module {
  ...
  func.func private @generate_task_graph() -> !sculptor.task_graph {
    ...
    %setup1 = sculptor.task.create %graph, @task_matrix_1, domain = "analog", task_kind = "sculptor.matrix_setup", task_name = "matrix_1", source_layer = "linear_0", source_task_ordinal = 1, inputs[], outputs[%array1], deps[%setup0] : (!sculptor.task_graph, !sculptor.task_resource<!sculptor.logical.array>, !sculptor.task) -> !sculptor.task

    return %graph : !sculptor.task_graph
  }
}

// ERR: logical analog array count exceeds physical analog array budget: 2 logical arrays require more than 1 physical analog arrays
