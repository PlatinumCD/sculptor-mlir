// RUN: sculptor-mlir-opt %s --sculptor-schedule-task-graph="cores=1 arrays-per-core=1 topology=mesh mesh-rows=1 mesh-cols=1 schedule=snake" | FileCheck %s
...
module {
  ...
  func.func private @generate_task_graph() -> !sculptor.task_graph {
    ...
    %a_out = sculptor.task_graph.temporary %graph {sculptor.runtime.byte_size = 8 : i64} : !sculptor.task_graph -> !sculptor.task_resource<tensor<1x2xf32>>
    %b_out = sculptor.task_graph.temporary %graph {sculptor.runtime.byte_size = 8 : i64} : !sculptor.task_graph -> !sculptor.task_resource<tensor<1x2xf32>>
    %x_out = sculptor.task_graph.temporary %graph {sculptor.runtime.byte_size = 8 : i64} : !sculptor.task_graph -> !sculptor.task_resource<tensor<1x2xf32>>
    %c_out = sculptor.task_graph.temporary %graph {sculptor.runtime.byte_size = 8 : i64} : !sculptor.task_graph -> !sculptor.task_resource<tensor<1x2xf32>>

    %a = sculptor.task.create %graph, @task_a, domain = "digital", task_kind = "digital.compute", task_name = "stage_a", source_layer = "layer", source_task_ordinal = 0, inputs[%input], outputs[%a_out], deps[] {sculptor.runtime.core_id = 0 : i64} : (!sculptor.task_graph, !sculptor.task_resource<tensor<1x2xf32>>, !sculptor.task_resource<tensor<1x2xf32>>) -> !sculptor.task
    %b = sculptor.task.create %graph, @task_b, domain = "digital", task_kind = "digital.compute", task_name = "stage_b", source_layer = "layer", source_task_ordinal = 1, inputs[%a_out], outputs[%b_out], deps[%a] {sculptor.runtime.core_id = 0 : i64} : (!sculptor.task_graph, !sculptor.task_resource<tensor<1x2xf32>>, !sculptor.task_resource<tensor<1x2xf32>>, !sculptor.task) -> !sculptor.task
    %x = sculptor.task.create %graph, @task_x, domain = "digital", task_kind = "digital.compute", task_name = "stage_x", source_layer = "layer", source_task_ordinal = 2, inputs[%input], outputs[%x_out], deps[] {sculptor.runtime.core_id = 0 : i64} : (!sculptor.task_graph, !sculptor.task_resource<tensor<1x2xf32>>, !sculptor.task_resource<tensor<1x2xf32>>) -> !sculptor.task
    %c = sculptor.task.create %graph, @task_c, domain = "digital", task_kind = "digital.compute", task_name = "stage_c", source_layer = "layer", source_task_ordinal = 3, inputs[%b_out, %x_out], outputs[%c_out], deps[%b, %x] {sculptor.runtime.core_id = 0 : i64} : (!sculptor.task_graph, !sculptor.task_resource<tensor<1x2xf32>>, !sculptor.task_resource<tensor<1x2xf32>>, !sculptor.task_resource<tensor<1x2xf32>>, !sculptor.task, !sculptor.task) -> !sculptor.task
    %d = sculptor.task.create %graph, @task_d, domain = "digital", task_kind = "digital.compute", task_name = "stage_d", source_layer = "layer", source_task_ordinal = 4, inputs[%c_out], outputs[%output], deps[%c] {sculptor.runtime.core_id = 0 : i64} : (!sculptor.task_graph, !sculptor.task_resource<tensor<1x2xf32>>, !sculptor.task_resource<tensor<1x2xf32>>, !sculptor.task) -> !sculptor.task
